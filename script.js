...
import wordwrapjs from 'https://cdn.jsdelivr.net/npm/wordwrapjs@5.1.0/+esm';
...
const pentatonic = ['F#1','A2', 'B2', 'C#3', 'E3', 'F#3', 'A3', 'B3', 'C#4', 'E4'];
...
let Graph = ForceGraph3D()
    ...
    .linkThreeObject(link => {
        ...
        // let text = createTextSprite(`${Math.Random()} placeholder`, "white");
...
function createTextSprite(text, color) {
    ...
    let wrappedText = wordwrapjs.wrap(text, {
...
let gradientGeometry = new THREE.PlaneBufferGeometry(2, 2);
